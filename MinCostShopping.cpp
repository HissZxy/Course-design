#include<stdio.h>
#include<stdlib.h>//system("paudse")库函数的引用
#define N 10//每种商品的最大数量
#define B 5//最大商品种类数
...
void minCost()
{
	...
	for(int j=0;j<s;++j)
	{
		 ...
		 quatity2=product[1]-offer[j][2];//第二种商品扣除当前优惠组合下的购买量的其他购买量
		 quatity3=product[2]-offer[j][3];//第三种商品扣除当前优惠组合下的购买量的其他购买量
		 quatity4=product[3]-offer[j][4];//第四种商品扣除当前优惠组合下的购买量的其他购买量
		 quatity5=product[4]-offer[j][5];//第五种商品扣除当前优惠组合下的购买量的其他购买量
